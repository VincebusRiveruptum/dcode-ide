...
void t_drawDebugger(){
    ...
    dw_writeBuffer(textmemptr, "cursorCol: %d", VIDEO_COLS - 15, 3, VIDEO_COLS - 1, 3,settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->cursorCol );
    dw_writeBuffer(textmemptr, "Existing lines: %d", VIDEO_COLS - 20, 4, VIDEO_COLS - 1, 4,settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->file->lines->length );
    dw_writeBuffer(textmemptr, "Deleted lines: %d", VIDEO_COLS - 20, 5, VIDEO_COLS - 1, 5,settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->file->deletedLines->length );
    ...
    dw_writeBuffer(textmemptr, "Line length: %d", VIDEO_COLS - 20, 8, VIDEO_COLS - 1, 8, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->currentLine->length);
    dw_writeBuffer(textmemptr, "selectedStartX: %d", VIDEO_COLS - 20, 9, VIDEO_COLS - 1, 9, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->selectedStartX);
    dw_writeBuffer(textmemptr, "selectedEndX: %d", VIDEO_COLS - 20, 10, VIDEO_COLS - 1, 10, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->selectedEndX);
    dw_writeBuffer(textmemptr, "selectedStartLine: %d", VIDEO_COLS - 20, 11, VIDEO_COLS - 1, 11, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->selectedStartLine);
    dw_writeBuffer(textmemptr, "selectedEndLine: %d", VIDEO_COLS - 20, 12, VIDEO_COLS - 1, 12, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->selectedEndLine);
    dw_writeBuffer(textmemptr, "oldCol: %d", VIDEO_COLS - 15, 13, VIDEO_COLS - 1, 13, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->oldCol);
    dw_writeBuffer(textmemptr, "oldLine: %d", VIDEO_COLS - 15, 14, VIDEO_COLS - 1, 14, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->oldLine);
    dw_writeBuffer(textmemptr, "isActive: %d", VIDEO_COLS - 15, 15, VIDEO_COLS - 1, 15, settings.STATUSBAR_COLOR_TEXT, settings.STATUSBAR_COLOR_BG, currentWindow->textArea->isActive);
